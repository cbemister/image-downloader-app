...
var stockNumApp = {
        ...
        , pressKey: function () {
            ...
            function getBtn(key) {
                if (stockNumApp.step === 1) {
                    stockNumApp.$get_button.click();
                }
                else if (stockNumApp.step === 2) {
                    stockNumApp.downloadImages();
                    stockNumApp.downloadInfo();
                }
            }
    }
    , getStockNumbers: function () {
        ...
        var table = makeTable(stockNumApp.vehicleData);
        ...
        $('img.vehiclePhoto.thumbnail').on('click', function () {
        ...
        if (this.step == 1) {
            ...
            $('button.get_info_button').css('display', 'initial');
            $('button.get_info_button').css('background', '#1d8804');
        }
        else {
        ...
        if (this.singleSearch === null) {
            $('div#sideBtn button.download_csv_button').css('display', 'none');
        }
    }, resetBtn: function () {
